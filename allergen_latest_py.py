...
Original file is located at
    https://colab.research.google.com/drive/1nTINe-U82weWQaLDL1_KrtDy3oNzg9zp
...
#food101からテストデータをimportする書き換える

predict_allergens(model, img_path, class_names, allergens)
...
def predict_allergens(model, img_path, class_names, allergen_dict):
    ...
    print(f'画像: {img_path}')
    print(f'予測された料理名: {predicted_class}')
    print(f'信頼度: {confidence:.2f}')
    print(f'アレルゲン: {", ".join(allergens) if allergens else "（なし）"}')
